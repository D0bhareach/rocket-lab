...
// This approach is adding latency to each request to server
// Better error handling is sertanly required. This code is simple copy-paste
// place it here for convinience. This approach is not used in code yet.
